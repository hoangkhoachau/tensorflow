...
#ifndef XLA_DEPRECATED_TESTS_HLO_TEST_BASE_LEGACY_H_
#define XLA_DEPRECATED_TESTS_HLO_TEST_BASE_LEGACY_H_
...
#endif  // XLA_DEPRECATED_TESTS_HLO_TEST_BASE_LEGACY_H_
