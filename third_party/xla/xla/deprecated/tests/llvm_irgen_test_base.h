...
#ifndef XLA_DEPRECATED_TESTS_LLVM_IRGEN_TEST_BASE_H_
#define XLA_DEPRECATED_TESTS_LLVM_IRGEN_TEST_BASE_H_
...
#endif  // XLA_DEPRECATED_TESTS_LLVM_IRGEN_TEST_BASE_H_
