...
#ifndef XLA_DEPRECATED_TOOLS_HLO_BISECT_HLO_BISECT_STATE_H_
#define XLA_DEPRECATED_TOOLS_HLO_BISECT_HLO_BISECT_STATE_H_
...
#endif  // XLA_DEPRECATED_TOOLS_HLO_BISECT_HLO_BISECT_STATE_H_
