...
#ifndef XLA_BACKENDS_GPU_TESTS_RESTRICTED_GPU_CODEGEN_TEST_H_
#define XLA_BACKENDS_GPU_TESTS_RESTRICTED_GPU_CODEGEN_TEST_H_
...
#endif  // XLA_BACKENDS_GPU_TESTS_RESTRICTED_GPU_CODEGEN_TEST_H_
